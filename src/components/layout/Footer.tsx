    ...
    return (
        <footer className="py-12 lg:py-16 xl:py-24 bg-gray-100 dark:bg-gray-650">
            <div className="container">
                <h5 className=" text-center md:text-left text-3xl md:text-4xl lg:text-5xl max-w-xl font-semibold text-gray-700 dark:text-primary-100">Let’s work together on your next product.</h5>
                <div className="flex flex-col md:flex-row items-center justify-between mt-4 md:mt-12 lg:mt-14">
                    ...
                    <div className=" flex items-center text-lg gap-5">
                        <Link target="_blank" to={'https://github.com/tarikCekirge'} className="text-gray-900 dark:text-primary-200">Personal Blog</Link>
