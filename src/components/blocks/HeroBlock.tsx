            ...
            <div className="container">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-8 xl:gap-12">
                    <div className='flex-1 flex flex-col gap-4 xl:gap-[40px]'>
                        <span>Almila Su</span>
                        <h1 className='text-4xl md:text-xlg xl:text-7xl font-bold text-gray-700'> Creative thinker  Minimalism lover </h1>
                        <p className='text-muted-foreground text-lg leading-snug'>Hi, I’m Tarik. I’m a full-stack developer. If you are looking for a Developer who to craft solid and scalable frontend products with great user experiences. Let’s shake hands with me.</p>
