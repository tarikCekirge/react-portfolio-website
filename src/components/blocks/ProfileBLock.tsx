    ...
    return (
        <section className="py-8 lg:py-16">
            <div className="container">
                {/* Profile Block Title */}
                <BlockTitle>{profileTitle || "Profil"}</BlockTitle>
                <div className="grid lg:grid-cols-[1fr_2fr] gap-6 md:gap-10 lg:gap-12">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="space-y-3 text-muted-foreground dark:text-white [&>p]:leading-snug">
                            <p>{content || "Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam aut, odit laborum aliquam voluptatum nisi mollitia. Minima accusamus ratione soluta aperiam sit voluptate? Dicta quod deserunt quam temporibus cumque magnam!"}</p>
                        </div>
                    </div>
                </div>
            </div>
